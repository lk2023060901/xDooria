...
const file_user_user_proto_rawDesc = "" +
	"\n" +
	"\x0fuser/user.proto\x12\x04user\x1a\x1bbuf/validate/validate.proto\"\x88\x01\n" +
	"\x11CreateUserRequest\x126\n" +
	"\busername\x18\x01 \x01(\tB\x1a\xbaH\x17r\x15\x10\x03\x1822\x0f^[a-zA-Z0-9_]+$R\busername\x12\x1d\n" +
	"\x05email\x18\x02 \x01(\tB\a\xbaH\x04r\x02`\x01R\x05email\x12\x1c\n" +
	"\x03age\x18\x03 \x01(\x05B\n" +
	"\xbaH\a\x1a\x05\x18\x96\x01(\x00R\x03age\"G\n" +
