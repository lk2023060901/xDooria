...
func (l *RaftLayer) Dial(address raft.ServerAddress, timeout time.Duration) (net.Conn, error) {
	// Note: Don't set LocalAddr for LAN connections as it causes "address already in use" errors
	// when the listener is already bound to that address. The OS will choose an ephemeral port.
	...
	// Check for tls mode
	if l.tlsFunc != nil && l.tlsFunc(address) && l.tlsWrap != nil {
