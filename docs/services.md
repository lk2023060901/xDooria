...
XStory 游戏服务端采用微服务架构，共包含 15 个独立服务进程。每个服务负责特定的业务功能，通过 gRPC 进行通信。
...
各业务服务 (Game/Hall/Room/Match/Team/Chat/Friend/Guild/Mail/Trading/Home/Doll/Rank)
  ↓
基础设施 (PostgreSQL/Redis/NSQ/etcd)
```
